        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm">
                    ...
                    <p class="text-gray-600">"The customer service is outstanding. Had a small issue with my order and they resolved it immediately. Plus, the clothes are amazing!"</p>
                </div>
            </div>
        </div>
    </section>
