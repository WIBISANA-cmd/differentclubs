                            ...
                            <div class="flex justify-between items-start">
                                <div>
                                    <div class="flex items-center gap-3">
                                        ...
                                        <span x-show="quickViewProduct.discountPercent" class="inline-flex items-center px-2 py-0.5 rounded-full bg-gray-900 text-white text-xs font-semibold" x-text="'diskon ' + quickViewProduct.discountPercent + '%'"></span>
                                    </div>
                                </div>
