    ...
    <header class="sticky top-0 z-50" data-parallax data-parallax-speed="0.15">
        <div class="container mx-auto px-4 py-4">
            <div class="flex items-center justify-between rounded-full bg-white/65 border border-white/50 backdrop-blur-xl shadow-lg shadow-black/5 px-4 md:px-6 py-3">
